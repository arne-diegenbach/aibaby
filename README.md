...
against matched marginals at 0.389 and 0.542. (The ~16 SE in that log is the
*margin* column's, not the fraction's; the rewritten verdict was never re-run, and
`travelsweep` reproduces the arm to print it.) With contexts on,
