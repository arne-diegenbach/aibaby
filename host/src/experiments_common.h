...
bool run_compartprobe(const std::vector<uint8_t>&, uint64_t, bool);
...
bool run_axispower(const std::vector<uint8_t>&, uint64_t, bool);
bool run_bumpwalk(const std::vector<uint8_t>&, uint64_t, bool);
